# input nama customer dan tanggal belanja , simpan dalam tuple 
nama = input("masukkan nama customer: ")
tanggal = input("Masukkan tanggal belanja (contoh: 15-04-2025): ")
...
# input data tiap barang, simpan dalan dictionary
daftar_belanja= [] # list untuk menyimpan dictionary 
